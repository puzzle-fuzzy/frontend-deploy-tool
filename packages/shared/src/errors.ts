...
export const ErrorCode = {
  ...
  STORAGE_CONTROL_CONFLICT: 'STORAGE_CONTROL_CONFLICT',
  STORAGE_QUOTA_EXCEEDED: 'STORAGE_QUOTA_EXCEEDED',
  ZIP_RATIO_EXCEEDED: 'ZIP_RATIO_EXCEEDED',
  RELEASE_CONFLICT: 'RELEASE_CONFLICT',
  AUDIT_NOT_FOUND: 'AUDIT_NOT_FOUND',
  AUDIT_REQUIRED: 'AUDIT_REQUIRED',
  AUDIT_BLOCKED: 'AUDIT_BLOCKED',
  AUDIT_FAILED: 'AUDIT_FAILED',
  AUDIT_JOB_NOT_FOUND: 'AUDIT_JOB_NOT_FOUND',
  AUDIT_JOB_CONFLICT: 'AUDIT_JOB_CONFLICT',
  AUDIT_JOB_FAILED: 'AUDIT_JOB_FAILED',
  AUDIT_QUEUE_FULL: 'AUDIT_QUEUE_FULL',
  INVALID_AUDIT_JOB_CURSOR: 'INVALID_AUDIT_JOB_CURSOR',
  INVALID_AUDIT_POLICY: 'INVALID_AUDIT_POLICY',
  ...
  API_TOKEN_SCOPE_REQUIRED: 'API_TOKEN_SCOPE_REQUIRED',
